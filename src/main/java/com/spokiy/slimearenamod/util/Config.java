...
public class Config {
    ...
    public static final int THROWN_PUMPKIN_EFFECT_DURATION = 5;
    ...
    public static final EffectConfig HUNTER_ABILITY_EFFECT =
            new EffectConfig(StatusEffects.GLOWING, 20 * 8, 0, true,false,true);
    public static final EffectConfig HUNTER_ABILITY_BUFF =
            new EffectConfig(StatusEffects.INVISIBILITY, 20 * 5, 0, true,false,true);
    ...
    public static final EffectConfig[] TRAPPER_TRAP_EFFECTS = {
            new EffectConfig(StatusEffects.GLOWING, 20 * 8, 0, false,false,true),
            new EffectConfig(StatusEffects.SLOWNESS, 20 * 6, 4, false,true,true),
    };
    ...
    public static final Map<String, EffectConfig> SUPPORT_ABILITY_SLOWNESS_EFFECTS = Map.of(
            "ally", new EffectConfig(StatusEffects.SPEED, 20 * 4, 3, false, true, true),
            "enemy", new EffectConfig(StatusEffects.SLOWNESS, 20 * 4, 3, false, true, true)
    );
